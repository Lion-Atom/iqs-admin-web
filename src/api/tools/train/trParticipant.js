...
export function batchSavePartV2(data) {
  return request({
    url: 'api/trParticipant/batchSaveV2',
    method: 'post',
    data
  })
}
...
export default { addPart, editPart, delPart, getPartsByTrScheduleId, batchSavePart, batchSavePartV2, getTrParticipantByExample }
