  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        ...
        <el-select v-model="query.auditType" clearable size="small" placeholder="审核类型" class="filter-item"
        ...
        <el-select v-model="query.auditStatus" clearable size="small" placeholder="审核状态" class="filter-item"
                   style="width: 120px" @change="crud.toQuery"
        >
    ...
    >
      <el-form ref="form" inline :model="form" :rules="rules" size="small" label-width="120px">
        ...
        <el-form-item v-if="form.auditStatus !== null " label="审核状态" prop="auditStatus">
          <el-select disabled v-model="form.auditStatus" size="small" placeholder="审核状态" class="filter-item"
                     style="width: 120px"
          >
            <el-option v-for="item in dict.approval_status" :key="item.label" :label="item.label" :value="item.label"/>
          </el-select>
        ...
        <el-form-item label="审核类型" prop="auditType">
          <el-select :disabled="form.isTop ==='0'" v-model="form.auditType" clearable size="small" placeholder="审核类型" class="filter-item"
                     style="width: 120px"
          >
            <el-option v-for="item in dict.audit_type" :key="item.value" :label="item.value" :value="item.value"/>
          </el-select>
