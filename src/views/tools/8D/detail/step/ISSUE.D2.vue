    ...
    <el-card class="box-card">
      ...
      <div>
        ...
        <el-table
          ...
          style="width: 100%;"
        >
          <el-table-column prop="caPartNum" label="产品料号" min-width="80"/>
          <el-table-column prop="componentDateCode" label="产品生产日期" width="140"/>
          <el-table-column prop="componentLotNum" label="产品批号" min-width="120"/>
          <el-table-column prop="defectQuantity" label="不良数量" min-width="80"/>
          <el-table-column label="客户影响" min-width="180">
