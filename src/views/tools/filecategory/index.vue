  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div v-if="crud.props.searchToggle">
        <!-- 搜索 -->
        <el-input v-model="query.name" clearable size="small" placeholder="输入文件分类名称搜索" style="width: 200px;" class="filter-item" @keyup.enter.native="crud.toQuery" />
...
const defaultForm = { id: null, name: null, isTop: '1', subCount: 0, pid: null, description: '无', cateSort: 999, enabled: 'true' }
export default {
  name: 'FileCategory',
